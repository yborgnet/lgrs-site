/**
 * Analyse en lecture seule du GPX original Ötztal
 * (data/gpx-sources/alpes-ligures-traversee-2024.original.gpx) pour recalculer
 ...
 *
 * Ne modifie rien : `node --experimental-strip-types scripts/gpx-report-alpes-ligures.ts`
 */
...
const GPX_PATH = path.join(ROOT, "data/gpx-sources/alpes-ligures-traversee-2024.original.gpx");
