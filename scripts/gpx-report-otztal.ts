 ...
 * (data/gpx-sources/autriche-otztal-2024.original.gpx) pour recalculer
 ...
 *
 * Ne modifie rien : `node --experimental-strip-types scripts/gpx-report-otztal.ts`
 */
...
const GPX_PATH = path.join(ROOT, "data/gpx-sources/autriche-otztal-2024.original.gpx");
